...
const Profile = () => {
  return (
    <div className="mx-auto flex h-96 w-3/4 flex-col gap-10 overflow-auto rounded-md bg-stone-50 shadow-lg">
      ...
      <div className="mx-auto flex w-3/4 flex-col gap-6">
        <p className="rounded-md bg-stone-300 px-24 py-3 shadow-sm">
          Username: John
        </p>
        <p className="rounded-md bg-stone-300 px-24 py-3 shadow-sm">
          Password: ********
